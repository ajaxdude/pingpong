...
export function deepMergeConfig(base: PingpongConfig, partial: Record<string, unknown>): PingpongConfig {
...
export function applyEnvOverrides(config: PingpongConfig): PingpongConfig {
